  ...
  public: {
    Tables: {
      ...
      chat_conversation_deletions: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_conversation_deletions_conversation_id_fkey"
          ...
          },
          {
            ...
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "chat_conversations_with_details"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "chat_conversation_deletions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      chat_user_presence: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_user_presence_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "admin_users"
            referencedColumns: ["id"]
      ...
      client_follow_ups: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "client_follow_ups_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      depreciation_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "depreciation_records_asset_fkey"
          ...
          {
            foreignKeyName: "depreciation_records_company_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      fixed_asset_accounts: {
        Row: {
          ...
          company_id: string
          created_at: string | null
          depreciation_calculation_method: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "fixed_asset_accounts_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "fixed_asset_accounts"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "fixed_assets_department_fkey"
          ...
          {
            foreignKeyName: "fixed_assets_internal_product_fkey"
          ...
          {
            foreignKeyName: "fixed_assets_serial_fkey"
            columns: ["serial_id"]
            isOneToOne: false
      ...
      internal_product_price_history: {
        Row: {
          company_id: string
          cost_price: number
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "internal_product_price_history_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "internal_product_price_history_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "internal_products"
            referencedColumns: ["id"]
      ...
      internal_product_serials: {
        Row: {
          company_id: string
          condition: Database["public"]["Enums"]["conditions"] | null
          created_at: string
          created_by: string
          current_location: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "internal_product_serials_fixed_asset_id_fkey"
            columns: ["fixed_asset_id"]
            isOneToOne: false
            referencedRelation: "fixed_assets"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      chat_conversations_with_details: {
        Row: {
          company_id: string | null
          created_at: string | null
          created_by: string | null
    ...
    Functions: {
      ...
      seed_default_fixed_asset_accounts: {
        Args: { p_company_id: string }
        Returns: undefined
      }
