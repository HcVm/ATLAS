-- Script para corregir campos sin tocar columnas generadas
-- Este script evita actualizar columnas como confirmed_at que son generadas automáticamente
...
BEGIN
    ...
    -- Insertar el usuario en auth.users sin columnas generadas
...
-- Actualizar solo los campos que NO son generados
DO $$
DECLARE
    v_count int;
    v_now timestamp with time zone := NOW();
BEGIN
    -- Actualizar solo los campos básicos que NO son columnas generadas
    UPDATE auth.users
    SET 
...
DO $$
BEGIN
    RAISE NOTICE 'Script completado sin tocar columnas generadas.';
    RAISE NOTICE 'Los campos básicos de autenticación han sido corregidos.';
