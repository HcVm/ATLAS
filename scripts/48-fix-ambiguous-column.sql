-- Script para corregir el problema de la columna ambigua
...
BEGIN
    ...
    -- Corregido: especificar explícitamente auth.users.email para evitar ambigüedad
    UPDATE auth.identities
    SET provider_id = auth.users.email
    FROM auth.users
