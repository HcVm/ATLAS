-- Primero, verificar el tipo de datos de la columna department_id en departments
-- y ajustar la función para manejar correctamente los tipos

-- Eliminar la función anterior
DROP FUNCTION IF EXISTS public.register_user(text, text, text, integer);

-- Crear la función corregida con el tipo correcto para department_id
