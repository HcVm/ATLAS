-- ============================================================================
-- AGREGAR NUMERACIÓN A COTIZACIONES Y MEJORAR MÓDULO DE VENTAS
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_quotations_company_year ON quotations(company_id, EXTRACT(YEAR FROM quotation_date));
...
-- 13. Crear índices para ventas
CREATE INDEX IF NOT EXISTS idx_sales_number ON sales(sale_number);
CREATE INDEX IF NOT EXISTS idx_sales_company_year ON sales(company_id, EXTRACT(YEAR FROM sale_date));
...
WHERE routine_name IN ('generate_quotation_number', 'generate_sale_number', 'set_quotation_number', 'set_sale_number')
