      ...
      <div className="container mx-auto py-8 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              {selectedCompany && <span className="ml-2 text-foreground font-medium">- {selectedCompany.name}</span>}
          ...
          <Dialog open={showNewQuotationDialog} onOpenChange={setShowNewQuotationDialog}>
            ...
            <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto bg-background border-border">
              <DialogHeader>
                <DialogTitle className="text-foreground">Crear Nueva Cotización</DialogTitle>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-card border-border shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Total Cotizaciones</CardTitle>
          ...
          <Card className="bg-card border-border shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Monto Cotizado</CardTitle>
              <div className="w-8 h-8 bg-muted rounded-lg flex items-center justify-center">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                S/{" "}
                {stats.totalQuotedAmount.toLocaleString("es-PE", {
          ...
          <Card className="bg-card border-border shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Promedio</CardTitle>
              <div className="w-8 h-8 bg-muted rounded-lg flex items-center justify-center">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-foreground">
                S/{" "}
                {stats.averageQuotation.toLocaleString("es-PE", { minimumFractionDigits: 2, maximumFractionDigits: 4 })}
              </div>
          ...
          <Card className="bg-card border-border shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Aprobadas</CardTitle>
              <div className="w-8 h-8 bg-muted rounded-lg flex items-center justify-center">
                <Clock className="h-4 w-4 text-muted-foreground" />
              </div>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-foreground">{stats.approvedQuotations}</div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50 border-border">
                    ...
                    <TableHead className="text-foreground">Productos</TableHead>
                    ...
                    {canViewAllQuotations && <TableHead className="text-foreground">Creado por</TableHead>}
                ...
                <TableBody>
                  {filteredQuotations.length === 0 ? (
                    ...
                    filteredQuotations.map((quotation) => {
                      ...
                      return (
                        <TableRow key={quotation.id} className="hover:bg-muted/50 border-border">
                          ...
                          <TableCell className="font-medium text-foreground">{quotation.entity_name}</TableCell>
                          <TableCell className="text-muted-foreground">{quotation.entity_ruc}</TableCell>
                          <TableCell
                          ...
                          <TableCell className="text-muted-foreground">{displayData.quantity}</TableCell>
                          <TableCell className="font-medium text-foreground">
                            S/{" "}
                            {displayData.totalAmount.toLocaleString("es-PE", {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 4,
                            })}
                          </TableCell>
                          ...
                          {canViewAllQuotations && (
                            <TableCell className="text-muted-foreground">
                              {quotation.profiles?.full_name || "N/A"}
                            </TableCell>
                          )}
                          <TableCell>
                                  ...
                                  {(quotation.status === "draft" || quotation.status === "rejected") &&
                                    (quotation.created_by === user?.id || canViewAllQuotations) && (
                                      <DropdownMenuItem
                                        ...
                                        className="text-destructive hover:bg-accent focus:bg-accent focus:text-destructive"
                                      >
        ...
        <Dialog open={showEditStatusDialog} onOpenChange={setShowEditStatusDialog}>
          <DialogContent className="bg-background border-border">
            <DialogHeader>
              <DialogTitle className="text-foreground">Cambiar Estado de Cotización</DialogTitle>
              <DialogDescription className="text-muted-foreground">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="new_status" className="text-foreground">
                  Nuevo Estado
                </Label>
            ...
            <div className="flex justify-end space-x-2 mt-4">
              ...
              <Button onClick={updateQuotationStatus} className="bg-primary hover:bg-primary/90">
                Actualizar Estado
              </Button>
            </div>
          </DialogContent>
        ...
        <Dialog open={showEditContentDialog} onOpenChange={setShowEditContentDialog}>
          <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto bg-background border-border">
            <DialogHeader>
              <DialogTitle className="text-foreground">Editar Cotización</DialogTitle>
              <DialogDescription className="text-muted-foreground">
        ...
        <Dialog open={showDetailsDialog} onOpenChange={setShowDetailsDialog}>
          <DialogContent className="max-w-6xl max-h-[95vh] overflow-hidden bg-background border-border">
            <DialogHeader>
              <DialogTitle className="text-foreground">Detalles de Cotización</DialogTitle>
              <DialogDescription className="text-muted-foreground">
            ...
            {selectedQuotation && (
              <Tabs defaultValue="details" className="w-full">
                <TabsList className="grid w-full grid-cols-2 bg-muted">
                  ...
                  <TabsTrigger value="route" className="flex items-center gap-2 data-[state=active]:bg-background">
                ...
                <TabsContent value="details" className="max-h-[70vh] overflow-y-auto">
                  <div className="space-y-6">
                    ...
                    <Card className="bg-card border-border">
                      <CardHeader>
                        <CardTitle className="text-lg text-foreground">Información del Cliente</CardTitle>
                      </CardHeader>
                      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <Label className="text-sm font-medium text-muted-foreground">Razón Social</Label>
                          <p className="text-sm font-medium text-foreground">{selectedQuotation.entity_name}</p>
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-muted-foreground">RUC</Label>
                          <p className="text-sm text-foreground">{selectedQuotation.entity_ruc}</p>
                        </div>
                        <div className="md:col-span-2">
                          <Label className="text-sm font-medium text-muted-foreground">Dirección Fiscal</Label>
                          <p className="text-sm text-foreground">
                            {selectedQuotation.sales_entities?.fiscal_address ||
                              selectedQuotation.delivery_location ||
                              "No especificada"}
                          </p>
                        </div>
                        <div className="md:col-span-2">
                          <Label className="text-sm font-medium text-muted-foreground">Lugar de Entrega</Label>
                          <p className="text-sm text-foreground">{selectedQuotation.delivery_location}</p>
                        </div>
                      </CardContent>
                    </Card>
                      ...
                      <CardContent className="space-y-4">
                        {selectedQuotation.quotation_items && selectedQuotation.quotation_items.length > 0 ? (
                          <div className="space-y-4">
                            {selectedQuotation.is_multi_product ? (
                              ...
                              <>
                                ...
                                <div className="mt-4">
                                  <h4 className="font-medium text-foreground mb-2">Lista de Productos:</h4>
                                      ...
                                      <div>
                                        ...
                                        <div className="mt-2 w-full max-w-md">
                                          <img
                                            ...
                                            className="w-full h-48 object-contain bg-muted rounded-lg border border-border"
                                            onError={(e) => {
                                              e.currentTarget.style.display = "none"
                                            }}
                                          />
                            ...
                            <div className="border-t border-border pt-4">
                              <div className="flex justify-between items-center">
                                <span className="text-lg font-medium text-foreground">Total de la Cotización:</span>
                                <span className="text-2xl font-bold text-primary">
                                  ...
                                  {selectedQuotation.quotation_items
                                    ...
                                    .toLocaleString("es-PE", { minimumFractionDigits: 2, maximumFractionDigits: 4 }) ||
                                    "0.00"}
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="text-center py-8">
                            <p className="text-muted-foreground">No hay productos en esta cotización</p>
                          </div>
                        )}
                      </CardContent>
                    </Card>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {selectedQuotation.contact_person && (
                              <div>
                                <Label className="text-sm font-medium text-muted-foreground">Contacto/Vendedor</Label>
                                <p className="text-sm font-medium text-foreground">
                                  {selectedQuotation.contact_person}
                                </p>
                              </div>
                            ...
                            {selectedQuotation.commission_notes && (
                              <div className="md:col-span-2">
                                <Label className="text-sm font-medium text-muted-foreground">Notas de Comisión</Label>
        ...
        <DeleteConfirmationDialog
          ...
          itemName={
            ...
            `#${quotationToDelete?.id.slice(0, 8)} - ${quotationToDelete?.entity_name}`
          }
