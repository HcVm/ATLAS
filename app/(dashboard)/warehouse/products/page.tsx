    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-background dark:via-background dark:to-muted/10">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-white to-slate-50/50 dark:from-card dark:to-card/50 border-slate-200/60 dark:border-border/50 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-800 dark:text-card-foreground">{products.length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-800 dark:text-card-foreground">
        ...
        <Card className="shadow-lg border-border/50 dark:border-border/50 bg-card/95 dark:bg-card/95">
          <CardHeader className="border-b border-border/50 dark:border-border/50">
            <CardTitle className="text-slate-700 dark:text-card-foreground font-semibold">
                  ...
                  <TableBody>
                    {filteredProducts.map((product) => {
                      ...
                      return (
                        <TableRow
                          key={product.id}
                          className="border-border/50 dark:border-border/50 hover:bg-slate-100 dark:hover:bg-muted"
                        >
                          <TableCell className="font-mono text-sm text-slate-800 dark:text-card-foreground">
                            {product.code}
                          </TableCell>
                          <TableCell>
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-medium text-slate-800 dark:text-card-foreground">{product.name}</p>
                                {product.description && (
                                  <p className="text-sm text-slate-500 dark:text-muted-foreground truncate max-w-xs">
                                    {product.description}
                                  </p>
                                )}
                              </div>
                          ...
                          <TableCell className="text-slate-800 dark:text-card-foreground">
                            {product.brands?.name || "-"}
                          </TableCell>
                          <TableCell>
                            <div className="text-slate-800 dark:text-card-foreground">
                          ...
                          <TableCell className="font-medium text-slate-800 dark:text-card-foreground">
