      ...
      <Card className="shadow-2xl border-slate-200/60 dark:border-slate-800/60 bg-white/50 dark:bg-slate-950/50 backdrop-blur-xl overflow-hidden rounded-2xl">
        ...
        <CardHeader className={`relative z-10 ${news.image_url ? "-mt-20 text-white" : "pb-4"}`}>
          <div className="flex flex-wrap gap-3 mb-4">
             <div className={`px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-md shadow-sm border border-white/20 flex items-center gap-1.5 ${
                news.published 
             ...
             <div className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-md shadow-sm border border-white/20 flex items-center gap-1.5 ${
                news.image_url ? "bg-black/40 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300"
             }`}>
          ...
          <div className={`flex items-center gap-3 mt-6 ${news.image_url ? "text-white/90" : "text-slate-500 dark:text-slate-400"}`}>
            <div className={`h-10 w-10 rounded-full flex items-center justify-center text-lg font-bold shadow-md ${
                news.image_url 
